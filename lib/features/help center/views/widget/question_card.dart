  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(
          title,style: AppTextStyles.withColor(
...
void _showAnswerBottomSheet(BuildContext context,String question, bool isDark){
  ...
  String _getAnswer(String question){
    final answers = {
     ...
     '7. Drop off the package at your nearest location\n\n'
     'Returns must be initiated within 30 days of delivery. Once we receive the item, your refind will be processed within 5-7 business days.'
    };
