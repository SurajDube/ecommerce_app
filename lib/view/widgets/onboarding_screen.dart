...
class OnboardingScreen extends StatefulWidget {
  ...
  final List<OnboardingItem> _items = [
    ...
    OnboardingItem(
        description: 'Simple and secure shopping experience at your fingerprints',
        title: 'Easy Shopping',
  ...
  void _handleGetStarted(){
    ...
    appController.setFirstTimeDone();
                ...
                Row(
                  ...
                  children: [
                    TextButton(onPressed: () => _handleGetStarted(),
                      child: Text("Skip",
                    style: AppTextStyles.withColor(AppTextStyles.buttonMedium,isDark ? Colors.grey[400]!
                        : Colors.grey[600]!,),
                    ),
                    ),
